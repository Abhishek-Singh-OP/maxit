    ...
    <section id="main-content shiftleft">
      <section class="wrapper site-min-height">
            ...
            <div class="row mt shiftright">
              <div class="col-md-6">
              <form id="frm_est" onsubmit="return validate_form();" action="<?=base_url()?>index.php/admin/add_est_form" method="post">
                <h3>Offer Heading</h3>
                ...
                <h3>Week Days</h3>
                <input type="text" name="txt_week_days" id="txt_week_days" class="form-control" value="" placeholder = "Week Days" />
