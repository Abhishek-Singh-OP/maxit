    ...
    <section id="container">
        <header class="header black-bg">
            ...
            <div class="top-menu">
                <ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?=base_url()?>index.php/auth/logout">Logout</a>
                    </li>
                </ul>
            </div>
        </header>
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                ...
                <div class="row mt">
                    <div class="col-lg-12">
                        <h3>Upload AR_AGING DATA</h3>
                        <?php echo form_open('admin/readxl');?>
                            <input type="file" id="aging" name="aging">
